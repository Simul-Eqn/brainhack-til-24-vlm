...
model_checkpoint_path = "model_checkpoint/model_2.pt"
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    #print("BBOX OF DISPLAY STR:", font.getbbox(display_str))
    #text_width, text_height = font.getsize(display_str)
    #print("WE WANT:", text_width, text_height) 
...
def caption_to_namestring(caption:str) -> str: 
    return caption # actually, the caption is just a direct description of the output so... 
...
class VLMManager:
    ...
    def identify(self, image: bytes, caption: str) -> List[int]: 
        ...
        category_name_string = caption_to_namestring(caption) 
        print("CATEGORY NAME STRNIG:", category_name_string)
        ...
        with Image.open(io.BytesIO(image)) as timg: timg.save("process_image.jpg") 

        params = max_boxes_to_draw, nms_threshold, min_rpn_score_thresh, min_box_area
        return main("process_image.jpg", category_name_string, params) 
        




def getImgBytes(path): 
